...
2. 다음 컴포넌트 추가:
   ...
   - NetworkObject
   - Apple 스크립트
3. 자식 오브젝트로 시각적 요소 추가:
   - Sphere 모델이나 커스텀 모델
   - Material 적용 (빨간색 또는 구분하기 쉬운 색상)
4. Tag를 "Apple"로 설정
5. 프리팹 저장 위치: `Assets/Donghyeon/@Resources/Prefabs/Snake/Apple.prefab`
...
현재 Body Detail 프리팹에 TextMeshPro 컴포넌트를 추가하여 값을 표시합니다:

1. `Assets/Donghyeon/@Resources/Prefabs/Snake/Body Detail.prefab` 열기
2. 자식 오브젝트로 TextMeshPro 추가:
